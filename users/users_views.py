...
def change_password(request):
	...
	return render(request, 'davur/modules/change-password.html', {'form': form, "page_title":"Change Password"})
...
def add_user(request):
	if request.method == 'POST':
		...
		form = CustomUserForm()		
	return render(request, 'davur/modules/add-user.html', {'form': form,"page_title":"Add User"})
...
def signup(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			message = render_to_string('davur/modules/account_activation/account_activation_email.html', {
					'user': user_obj,
...
def edit_user(request,id):
	...
	return render(request, 'davur/modules/add-user.html', {'form': form,"page_title":"Edit User"})
...
def group_edit(request,id):
	...
	return render(request, 'davur/modules/group-edit.html',{'form': form, "page_title":"Edit Group"})
...
def group_add(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			return render(request, 'davur/modules/group-add.html',{'form': form, 'page_title':'Add Group'})
	else:
		form = GroupForm()
		return render(request, 'davur/modules/group-add.html',{'form': form, "page_title":"Add Group"})
...
def edit_permissions(request,id):
	...
	if request.method == 'POST':
		...
		return render(request, 'davur/modules/edit-permissions.html',{'form': form, "page_title":"Edit Permissions"})
...
def assign_permissions_to_user(request,id):
	...
	return render(request, 'davur/modules/assign_permissions_to_user.html',{'form':form,"page_title":"Assign Permissions"})
