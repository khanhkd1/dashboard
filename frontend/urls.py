...
urlpatterns = [
    ...
    path('front-home/',frontend_views.front_home,name="front-home"),
    path('front-dashboard/',frontend_views.front_dashboard,name="front-dashboard"),
    ...
    path('front-reviews/',frontend_views.front_reviews,name="front-reviews"),
